...
write.table(reg_duplica_newcod, file="Biblioteca - Duplicados - 02 febrero.csv", sep = ";", row.names = FALSE)
write.table(reg_comparados, file="Biblioteca - Duplicados_Comparados - 02 febrero.csv", sep = ";", row.names = FALSE)
...
for (j in 1:1) {
  ...
  fun01 <- function() {
    ...
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p4 = 1 then p5 ≠ ∅; If p4 = 2 then p5 = ∅  - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun02 <- function() {
    ...
    reporte <- Mod01_newcod %>% filter(very == 1)
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p1 = 2 then p6 ≠ ∅; If p1 = 1 then p6 = ∅  - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun03 <- function() {
    ...
    reporte <- Mod01_newcod %>% filter(very == 1)
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p3_9 = 1 then p3_ot ≠ ∅; If p3_9 = 0 then p3_ot = ∅ - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun04 <- function() {
    ...
    reporte <- Mod01_newcod %>% filter(very == 1)
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p10_1 = 1 y p3_1, p3_3, p3_4, p3_6 o p3_7 = 1 then p12 ≠ ∅ - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun05 <- function() {
    ...
    reporte <- Mod01_newcod %>% filter(very == 1)
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p3_1, p3_3, p3_4, p3_5, p3_6, p3_7, p3_8 o p3_9 = 1 then p17 ≠ ∅; If p3_2 = 1 then p17 = ∅ - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun06 <- function() {
    ...
    reporte <- Mod01_newcod %>% filter(very == 1)
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p3_2 = 1 then p18_1_1, p18_1_2 o p18_1_3 ≠ ∅ - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun07 <- function() {
    ...
    reporte <- Mod01_newcod %>% filter(very == 1)
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p20 = 1 then p21 ≠ ∅; If p20 = 2 then p21 = ∅ - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun08 <- function() {
    ...
    reporte <- Mod01_newcod %>% filter(very == 1)
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p22_0 = 1 then p23 y p24 = ∅; p22_0 = 0 then p23 y p24 ≠ ∅ - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun09 <- function() {
    ...
    reporte <- Mod01_newcod %>% filter(very == 1)
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p22_5 = 1 then p22_ot ≠ ∅; If p22_5 = 0 then p22_ot = ∅ - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun10 <- function() {
    ...
    reporte <- Mod01_newcod %>% filter(very == 1)
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p25_0 = 1 then p25_1a y p26 = ∅; If p25_0 = 1 then p25_1a ≠ ∅ - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun11 <- function() {
    ...
    reporte <- Mod01_newcod %>% filter(very == 1)
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p25_1_1 = 1 then p26 ≠ ∅; If p25_1_1 = 0 then p26 = ∅ - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun12 <- function() {
    ...
    reporte <- Mod01_newcod %>% filter(very == 1)
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p26_1 = 7 then p26_1_ot ≠ ∅; If p26_1 = 1, 2, 3, 4, 5 o 6 then p26_1_ot = ∅ - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun13 <- function() {
    ...
    reporte <- Mod01_newcod %>% filter(very == 1)
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p27 = 1 then p28_1, p28_2, p28_3, p28_4 y p28_5 ≠ ∅; If p27 = 2 then p28_1, p28_2, p28_3, p28_4 y p28_5 = ∅ - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun14 <- function() {
    ...
    reporte <- Mod01_newcod %>% filter(very == 1)
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p29 = 1 then p30_1, p30_2 y p30_3 ≠ ∅; If p29 = 2 then p30_1, p30_2 y p30_3 = ∅ - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun15 <- function() {
    ...
    reporte <- Mod01_newcod %>% filter(very == 1)
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p31 = 1 then p32 y p33 ≠ ∅; If p33 = 1 then p34 y p35 ≠ ∅; If p35 = 1 then p36 ≠ ∅ - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun16 <- function() {
    ...
    reporte <- Mod01_newcod %>% filter(very == 1)
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p31 = 2 then p32, p33, p34, p35 y p36 = ∅ - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun17 <- function() {
    ...
    reporte <- Mod01_newcod %>% filter(very == 1)
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p39 = 1 o 2 then p39_1 y p40 = ∅; If p39 = 3 o 4 then p39_1 y p40 ≠ ∅ - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun18 <- function() {
    ...
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p45 = 1 then p45_1, p45_2, p45_3, p45_4_1 y p45_4_2 ≠ ∅; If p45_4_2 ≥ 1 then p45_5 ≠ ∅ - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun19 <- function() {
    ...
    reporte <- Mod01_newcod_0_1 %>% filter(very == 1)
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p45 = 2 then p45_1, p45_2, p45_3, p45_4_1, p45_4_2 y p45_5 = ∅ - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun20 <- function() {
    ...
    reporte <- Mod01_newcod_0_1 %>% filter(very == 1)
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p45_5_8 = 1 then p45_5_ot ≠ ∅; If p45_5_8 = 0 then p45_5_ot = ∅ - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun21 <- function() {
    ...
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p46 = 1 then p46_1, p46_2, 46_3, p46_4_1, p46_4_2 y p46_4_3 ≠ ∅ - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun22 <- function() {
    ...
    reporte <- Mod01_newcod_0_2 %>% filter(very == 1)
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p46 = 2 then p46_1, p46_2, 46_3, p46_4_1, p46_4_2 y p46_4_3 = ∅ - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun23 <- function() {
    ...
    reporte <- Mod01_newcod %>% filter(very == 1)
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p47_1_1 = 1 then p47_1_2 y p47_1_3 ≠ ∅; If p47_1_1 = 2 then p47_1_2 y p47_1_3 = ∅ - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
  ...
  fun24 <- function() {
    ...
    reporte <- Mod01_newcod %>% filter(very == 1)
    if (nrow(reporte) > 0) {
      write.table(reporte, file="Biblioteca - If p47_2_1 = 1 then p47_2_2 y p47_2_3 ≠ ∅; If p47_2_1 = 2 then p47_2_2 y p47_2_3 = ∅ - 02 febrero.csv", sep = ";", row.names = FALSE)
    } else {
      print(nrow(reporte))
    }
